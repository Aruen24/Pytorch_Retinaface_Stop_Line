...
def addCatItem(name):
    ...
    if category_item_id == 0:
        category_item['name'] = "false"
    if category_item_id == 1:
        category_item['name'] = "true"
    # category_item['name'] = category_item_id
        ...
        for elem in root:
            ...
            for subelem in elem:
                ...
                if current_parent == 'object' and subelem.tag == 'name':
                    ...
                    # print(object_name)
                    if object_name not in category_set:
                        current_category_id = object_name
                        addCatItem(object_name)
                        # current_category_id = addCatItem(object_name)
                    else:
                        # current_category_id = category_set[object_name]
                        current_category_id = object_name
...
if __name__ == '__main__':
    ...
    # 通过文件夹生成（已经经过验证）
    ann_path = ".\\images\\VOC2007/Annotations"
    json_save_path = ".\\images\\coco_train.json"

    # ann_path="./VOC2007_val/Annotations"
    # json_save_path="./coco_val.json"
